...
const Shipping = () => {
    ...
    const [numero_telefono, setNumero_telefono] = useState(shippingInfo.numero_telefono)
    ...
    const submitHandler = (e) => {
        ...
        dispatch(saveShippingInfo({ direccion, comuna, provincia, region, numero_telefono }))
